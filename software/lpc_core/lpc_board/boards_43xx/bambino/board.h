/*
 * @brief Micromint Bambino board file
 *
 * @note
...
/** @defgroup BOARD_BAMBINO LPC4330 NGX Xplorer board support software API functions
...
/** @defgroup BOARD_BAMBINO_OPTIONS BOARD: LPC4330 NGX Xplorer board options
...
#define BUTTONS_BUTTON1_PIN_PORT_NUM    2
#define BUTTONS_BUTTON1_PIN_BIT_NUM     7
#define BUTTONS_BUTTON1_MODE_FUNC       SCU_MODE_FUNC0
/* LED1 (Yellow) - Pin P6_11 : GPIO3[7] */
#define LED1_GPIO_PORT_NUM              3
#define LED1_GPIO_BIT_NUM               7
#define LED1_PIN_PORT_NUM               6
#define LED1_PIN_BIT_NUM                11
#define LED1_MODE_FUNC                  SCU_MODE_FUNC0
/* LED2 (Green) - Pin P2_5 : GPIO5[5] */
#define LED2_GPIO_PORT_NUM              5
