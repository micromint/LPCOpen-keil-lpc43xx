...
@ Mode      : Thumb2
@ Toolchain : LPCXpresso Tool chain
@             GNU GCC Tool chain 
@********************************************************************************************************
@
...
.EQU NVIC_SYSPRI2,       0xE000ED20                              @ System priority register (priority 14).
.EQU NVIC_PENDSV_PRI,    (0x7 << 21)                             @ PendSV priority value (lowest).
